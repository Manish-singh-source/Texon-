(function($) {
	...
	ArnicaOptions.mobile = $.browser.mobile;
	...
	$.ArnicaTheme = {
		...
		countdown:function() {
			if ($("#countdown").length>0) {
				var date = new Date("December 25, 2026 00:00:00");
