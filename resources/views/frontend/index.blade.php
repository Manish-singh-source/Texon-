...
@section('content')
    ...
    @if ($banners->count() > 0)
        ...
        <div class="hero hero-bg-image hero-video dark-section"
            @if ($banner->banner_image) style="background-image: url('{{ asset('storage/' . $banner->banner_image) }}');" @endif>
            <!-- Video Start -->
                                    ...
                                    @if ($banner->button_name && $banner->button_url)
                                        <div class="hero-btn">
                                            <a href="{{ $banner->button_url }}"
                                                class="btn-default btn-highlighted">{{ $banner->button_name }}</a>
                                        </div>
                                    @endif
                                    <!-- Hero Button End -->
                                </div>
                ...
                <div class="col-xl-6 order2">
                    ...
                    <div class="why-choose-image-box wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="why-choose-img-box-1">
                            ...
                            <div class="year-experience-box1">
            ...
            <div class="row">
                    ...
                    <div class="feature-item-box">
                        @foreach ($featuredProducts as $index => $product)
                            ...
                            <div class="feature-item box-{{ $index + 1 }} wow fadeInUp"
                                @if ($index > 0) data-wow-delay="{{ 0.2 * $index }}s" @endif>
                                <div class="feature-image">
                                    <figure>
                                        @if ($product->image)
                                            <img src="{{ asset('storage/' . $product->image) }}"
                                                alt="{{ $product->heading }}" class="imgh">
                                        @else
                                            <img src="assets1/img/prod{{ $index + 1 }}.png" alt=""
                                                class="imgh">
                                        @endif
                                    </figure>
                                </div>
                                <div class="feature-item-content">
                                    <h3><a href="{{ route('product-details', $product->product_id) }}"
                                            style="text-decoration: none; color: inherit;">{{ $product->heading }}</a>
                                    </h3>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="section-footer-text wow fadeInUp" data-wow-delay="0.8s">
                        <p><a href="{{ route('category') }}" style="text-decoration: none;"><span>View All Products
                                </span> </a> </p>
                        ...
                        <div class="service-item-body">
                            ...
                            <div class="service-item-header">
                                ...
                                <div class="service-item-btn">
                                    <a href="javascript:void(0);"><img src="assets1/images/arrow-primary.svg"
                                            alt=""></a>
                                </div>
                            </div>
                            ...
                            <div class="service-item-content">
                                <p>Deep domain knowledge in advanced motion capture, tracking software, and engineering
                                    technologies ensures reliable and accurate solutions.
                                </p>
                            </div>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item active wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="service-item-body">
                            ...
                            <!-- Service Item Content Start -->
                            <div class="service-item-content">
                                <p>We understand that every project is unique. Our solutions are tailored to meet specific
                                    application, industry, and research requirements.</p>
                            </div>
                            <!-- Service Item Content End -->
                        </div>
                        <!-- Service Item Body End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="service-item-body">
                            ...
                            <!-- Service Item Content Start -->
                            <div class="service-item-content">
                                <p>From consultation and system design to installation, training, and after-sales support,
                                    we provide complete lifecycle assistance.</p>
                            </div>
                            <!-- Service Item Content End -->
                        </div>
                        <!-- Service Item Body End -->
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="service-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="service-item-body">
                            ...
                            <!-- Service Item Content Start -->
                            <div class="service-item-content">
                                <p>Our solutions are designed to scale as your needs grow, ensuring long-term value and
                                    flexibility.
                                </p>
                            </div>
                            <!-- Service Item Content End -->
                ...
                <div class="col-xl-5 col-lg-6">
                    ...
                    <div class="our-testimonial-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-2" data-cursor="-opaque">What our clients say about
                                <span>partnering
                                    with us</span>
                                                    ...
                                                    <div class="testimonial-header">
                                                        <div class="testimonial-logo">
                                                            @if ($testimonial->testimonial_image)
                                                                <img src="{{ asset('storage/' . $testimonial->testimonial_image) }}"
                                                                    alt="{{ $testimonial->name }}">
                                                            @else
                                                                <img src="assets1/images/testimonial-company-logo-1.svg"
                                                                    alt="">
                                                            @endif
                                                        </div>
                                                    </div>

                                                    <h3 class="mt-3">{{ $testimonial->name }}</h3>
                ...
                @foreach ($blogs as $blog)
                    <div class="col-xl-4 col-md-6">
                        ...
                        <div class="post-item wow fadeInUp"
                            @if ($loop->index > 0) data-wow-delay="{{ 0.2 * $loop->index }}s" @endif>
    ...
    @if ($promotionalBanner)
        ...
        <div class="modal fade" id="promotionalModal" tabindex="-1" aria-labelledby="promotionalModalLabel"
            aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content border-0 shadow-lg">
                    @if ($promotionalBanner->title)
                        <div class="modal-header border-0 bg-primary text-white">
                            <h5 class="modal-title fw-bold" id="promotionalModalLabel">{{ $promotionalBanner->title }}
                            </h5>
                    ...
                    <div class="modal-body p-0">
                        @if ($promotionalBanner->banner_image)
                            <div class="promotional-banner-image">
                                <img src="{{ asset('storage/' . $promotionalBanner->banner_image) }}"
                                    class="img-fluid w-100" alt="{{ $promotionalBanner->title ?? 'Promotional Banner' }}"
